...
import { useCustomQuery } from '../hooks/useCustomHook'

const Students = () => {
    
    const {data, isPending, isError, isSuccess, error} = useCustomQuery("students", apiUrl)
    ...
    //   console.log(data);
      ...
      if (isPending) {
        return  <Typography color="error">Loading...</Typography>; // Hiển thị vòng tròn tải khi đang lấy dữ liệu
      } 
      ...
      // if (isSuccess) {
      //   return <Typography color="success">Success loading students:</Typography>; // Hiển thị thông báo truy van thanh cong
      // }
